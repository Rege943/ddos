...
if [ -f "/etc/debian_version" ]; then
        ...
        echo "[i] We will now download ddos..."
        sudo git clone https://github.com/Taguar258/ddos.git > /dev/null 2>&1 || echo "[!] Could not download ddos."
        cd ddos > /dev/null 2>&1
        ...
        echo "[i] We will now install ddos..."
        sudo bash ./install_to_bin.sh || echo "[!] Could not install ddos."
        ...
        git clone https://github.com/Taguar258/ddos.git > /dev/null 2>&1 || echo "[!] Please install git"
        cd ddos
